...
-- -----------------------------------------------------------------------------
-- 6. Browse restaurants with average rating
-- -----------------------------------------------------------------------------
-- Includes restaurants with no reviews (average_rating NULL, review_count 0).
SELECT
  r.restaurant_id,
  r.name,
  r.city,
...
-- -----------------------------------------------------------------------------
-- 7. Search restaurants by city
-- -----------------------------------------------------------------------------
-- Example: restaurants in Tempe.
SELECT restaurant_id, name, address, city, cuisine_type, price_range, phone, hours
FROM restaurants
WHERE city = 'Tempe'
ORDER BY name;
...
-- -----------------------------------------------------------------------------
-- 8. Search restaurants by cuisine type
-- -----------------------------------------------------------------------------
-- Example: Japanese restaurants.
SELECT restaurant_id, name, address, city, cuisine_type, price_range, phone, hours
FROM restaurants
...
-- -----------------------------------------------------------------------------
-- 9. View restaurant details with reviews
-- -----------------------------------------------------------------------------
-- Example: single restaurant (restaurant_id = 2) with each review and reviewer.
SELECT
  r.restaurant_id,
